...
extern RTC_DATA_ATTR int befriendedPlaymatesMask;
const String nvsKey_befriendedPlaymatesMask = "befriendedPMsMask";
...
const int MENUIDX_STROKE = 2;
const int MENUIDX_CONTEXT = 3;
