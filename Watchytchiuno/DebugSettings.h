#define VERBOSE_LOGGING_ENABLED 1 // 1 to enable all DBGPrints, 0 to disable for performance
...
#define FORCED_ACTIVE_IDLESCENE 4 // -1 to disable, 0+ to force an active idle scene idx
#define ULTRA_SHORT_IDLESCENES 0 // 0 for normal length idle scenes, 1 to reduce them to 30 seconds long